                    ...
                    <td colspan="4">
                        <form action="{{ route('admin.orders.ship', [$order->id]) }}" method="post"
                            ...
                            <div class="form-group {{ $errors->has('express_company') ? 'has-error' : '' }}">
                                ...
                                <input type="text" id="express_company" name="express_company" class="form-control"
                                       placeholder="输入物流公司">
                            ...
                            <div class="form-group {{ $errors->has('express_no') ? 'has-error' : '' }}">
                                ...
                                <input type="text" id="express_no" class="form-control" name="express_no"
                                       placeholder="输入物流单号">
            ...
            swal({
                ...
                $.ajax({
                    ...
                    data: JSON.stringify({
                        ...
                        reason: inputValue,
                        // 带上 CSRF Token
                        // Laravel-Admin 页面里可以通过 LA.token 获取 CSRF Token
                        _token: LA.token,
                    }),
